-- ==============================================================================
-- KARIM PATH LAB — COMPLETE SUPABASE DATABASE SCHEMA & INITIAL DATA
...
-- Allow Public Access (Read & Write for Admin sync)
...
-- Insert All 7 Pathology Tests & Health Packages (With 20% Discounted Prices)
